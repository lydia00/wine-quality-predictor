...
4. Enter username and password (Username = "username" and Password = "password".
5. Input chemical properties in the wine quality predictor fields and click **Predict wine quality** to generate a predicted rating and accuracy.
6. Scroll down to see data visualizations and a table of the raw data.